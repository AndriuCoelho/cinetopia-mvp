...
class MovieTableViewCell: UITableViewCell {
    ...
    lazy var favoriteButton: UIButton = {
        ...
        let iconImage = UIImage(systemName: "heart")?.withTintColor(UIColor(named: "ButtonBackgroundColor") ?? .purple, renderingMode: .alwaysOriginal)
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        addSubviews()
        setupConstraints()
        backgroundColor = .clear // ou .clear
    }
    ...
    func configureCell(movie: Movie) {
        ...
        let heartIcon = UIImage(systemName: "heart")?.withTintColor(UIColor(named: "ButtonBackgroundColor") ?? .purple, renderingMode: .alwaysOriginal)
        let heartFillIcon = UIImage(systemName: "heart.fill")?.withTintColor(UIColor(named: "ButtonBackgroundColor") ?? .purple, renderingMode: .alwaysOriginal)
        
        if movie.isSelected ?? false {
            favoriteButton.setImage(heartFillIcon, for: .normal)
        } else {
